...
//                Toast.makeText(activity, "Click on Card.", Toast.LENGTH_SHORT).show();
                ...
                intent.putExtra(MyConstant.HEADER_SMALL, title.get(position));
                if(MyConstant.MY_SELECTIONS.equals(title.get(position))){
                    intent.putExtra(MyConstant.SHOW_SMALL, MyConstant.FALSE_STRING);
                }else{
                    intent.putExtra(MyConstant.SHOW_SMALL,MyConstant.TRUE_STRING);
                }
